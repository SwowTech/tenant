        ...
        <div class="ibox">
          <div class="ibox-title">
            ...
            <div class="ibox-tools"> 
              <a href="../index.php?location=sitemap" class="btn btn-primary btn-xs" target="_blank">SiteMap</a> 
            <a href="../index.php?location=sitexml" target="_blank" class="btn btn-primary btn-xs">SiteXml</a>
            <a href="javascript:void(0)" class="btn btn-info btn-xs" onclick="opennew('?act=baidusiteapi')">推送SiteMap</a>
            <a href="javascript:void(0)" class="btn btn-success btn-xs" onclick="opennew('?act=robots')">创建默认robots.txt</a>
             </div>
          </div>
