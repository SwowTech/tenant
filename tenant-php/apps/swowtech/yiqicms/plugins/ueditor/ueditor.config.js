...
(function () {
     ...
     */
    var URL = sitepath +'plugins/ueditor/';
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: sitepath+ adminpath+"ueupload.php?upfolder="+upfolder
        ...
        , toolbars: [[
            ...
            'insertimage', 'emotion', 'scrawl', 'insertvideo', 'attachment', 'map', 'gmap', 'insertframe', 'insertcode', 'template', 'background', '|',
		...
		,whitList: {
			...
			source: ['src','type'],
			a:      ['target', 'href', 'title', 'class', 'style','name','id','download'],
			...
			sup:    ['class', 'style'],
			strong: ['class', 'style'],
			table:  ['width', 'border', 'align', 'valign', 'class', 'style', 'cellpadding','cellspacing','id'],
