      ...
      <div class="col-sm-12 animated fadeInDown">
        <form class="registerform" method="post" action="{zzz:sitepath}form/?reg">
          ...
          <div class="formsub">
            <li>
              <div>
                <input type="text" value="" name="username" class="form-control" datatype="*5-18" placeholder="请输入账号 "
                  ajaxurl="{zzz:sitepath}plugins/sms/sms.php?act=checkname&checktype=0" errormsg="账号范围5~18 " />
            ...
            <li>
              <div>
                <input type="text" value="" name="password" class="form-control" datatype="*5-16" placeholder="请输入密码"
                  errormsg="密码范围范围5~16" />
                <i class="fa fa-key"></i>
              </div>
              <div class="Validform_checktip"></div>
            ...
            <li>
              <div>
                <input type="text" value="" name="mobile" id="phonenum" class="form-control" datatype="m"
                  placeholder="请输入手机号 " ajaxurl="{zzz:sitepath}plugins/sms/sms.php?act=checkmobile "
                  errormsg="手机格式不正确 " />
            ...
            <li>
              <div>
                <input type="text" value="" name="email" id="email" class="form-control" datatype="e"
                  placeholder="请输入邮箱地址 " ajaxurl="{zzz:sitepath}plugins/sms/sms.php?act=checkemail "
                  errormsg="邮箱格式不正确 " />
            ...
            <li>
              <div>
                <input type="text" value="" name="smscode" id="smscode" class="form-control code" datatype="n4-4"
                  ajaxurl="{zzz:sitepath}plugins/sms/sms.php?act=checkcode" placeholder="请输入短信验证码" errormsg="验证码错误">
            ...
            {end if}
            <div class="row">
              <div class="col-sm-12"> <a a
                  href="{zzz:sitepath}?location=user&act=login&type=[user:type]&backurl=[user:backurl]"><span id="login">登陆账号</span></a>
                <a href="{zzz:sitepath}?location=user&act=forget&type=[user:type]&backurl=[user:backurl]"
                  class="pull-right">忘记密码？</a> </div>
            </div>
            <div class="action">
