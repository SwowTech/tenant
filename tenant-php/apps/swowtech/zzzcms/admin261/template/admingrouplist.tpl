...
<div class="wrapper wrapper-content">
  <div class="ibox float-e-margins">      <div class="row row-lg"> 
          ...
          <?php if(get_session('adminmark')>9999) echo '<button onClick="opennew(\'?act=adminmenu\')" class="btn btn-danger" type="button" title="权限大于9999可以设置"><i class="fa fa-cog"></i> 权限管理</button>';?>
