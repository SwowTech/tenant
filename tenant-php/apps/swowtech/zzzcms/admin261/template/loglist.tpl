        ...
        <div class="row row-lg">
          <div class="col-sm-12">
            <div class="col-sm-7">
              ...
              <button onClick="window.history.go(-1)" class="btn" type="button"><i class="fa fa-reply-all">　</i>返回</button>
            </div>
            <table {zzz:table} data-url="function.php?act=loglist&uid={$_GET 'uid'}">
              <thead>
                <tr>
                  <th class="tablename" data-field="id" data-sortable="true">ID</th>       
                  <th class="tablename" data-field="username" data-sortable="true">账号</th>        
                  <th class="tablename" data-field="ldesc" data-sortable="true">类型</th>
                  <th class="tablename" data-field="content" data-sortable="true">内容</th>
