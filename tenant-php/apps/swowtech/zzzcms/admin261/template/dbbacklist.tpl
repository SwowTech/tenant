    ...
    <div class="ibox-content">
      <div class="row row-lg">
        <div class="col-sm-12">
          ...
          <button onClick="closetab()" class="btn" type="button"><i class="fa fa-close">　</i>关闭</button>
           <button id="add" class="btn  btn-danger" type="button" onclick="delall('dbbacklist')"><i class="fa fa-plus">　</i>清空记录</button>
           </div>     
            <table {zzz:table50} data-url="function.php?act=dbbacklist">         
            <thead>
              <tr>
              <th class="tablename" data-field="name" data-sortable="true">日志名称</th>
