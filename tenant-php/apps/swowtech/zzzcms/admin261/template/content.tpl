...
<link href="../plugins/bootstrap/font-awesome.min.css?t=20251101" rel="stylesheet">
...
<script src="../plugins/ueditor/ueditor.config.js?t=20230418"></script>
<script src="../plugins/ueditor/ueditor.all.min.js?t=20230418"></script>
        ...
        <div id="tab-1" class="tab-pane active">
          <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <span class="text-danger m-t-20">内容介绍</span>
              <a  class="btn btn-info btn-block m-t-20" href="?act=ai&type=polish&table=content&id=[r:cid]"><i class="fa fa-robot "> </i> AI 润色</a>
              </label>
              <div class="col-sm-11">
