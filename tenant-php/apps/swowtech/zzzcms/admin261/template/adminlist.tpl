...
<div class="wrapper wrapper-content">
  <div class="ibox float-e-margins">      <div class="row row-lg"> 
         ...
         <button id="add" class="btn  btn-primary" type="button" onclick="opennew('?act=admin')"><i class="fa fa-plus">　</i>添加管理员</button>
           <a href="?act=loginlist" class="btn btn-default" type="button"><i class="fa fa-question-circle"></i> 登陆错误日志</a>
           {if get_session('adminmark')>10000}<a href="?act=loglist" class="btn btn-default" type="button"><i class="fa fa-history"></i> 全部操作日志</a>{/if}
