...
//            'gid' => 'require|number',
     ...
     * @return mixed
     */
    public function getAdminAll($page,$size,$search=null)
    {
        return AdminService::getInstance()->getAllAdmin($page,$size,$search);
    }
    ...
    {
        return AdminService::getInstance()->banAdmin($id);
    }
    /**
     * 设置前端管理员权限
     * @param $id
