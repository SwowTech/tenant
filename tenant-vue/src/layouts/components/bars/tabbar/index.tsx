          ...
          {tabStore.tabList?.map((item: any, idx: number) => {
            return (
              <a
                ...
                title={resolveMenuTitle({ name: item.name, meta: { i18n: item.i18n, title: item.title } }, key => useTrans(key) as string)}
              ...
              >
                ...
                <span class="title">
                  {resolveMenuTitle({ name: item.name, meta: { i18n: item.i18n, title: item.title } }, key => useTrans(key) as string)}
                </span>
